...
import { parameterAnnotation, parameterName, type ParameterOwner } from "../shared/parameters.ts";
    ...
    const checkParameters = (node: ParameterOwner) => {
      ...
      for (const parameter of node.params) {
        ...
        context.report({
          ...
          data: {
            parameter: parameterName(parameter, context.sourceCode.getText(parameter)),
          },
        });
      }
    };
